...
internal interface ILocationProvider
{
    ...
    /// <summary>
    ///     This method rather returns the amount of characters to grab from the back of the listing location info, including
    ///     spaces and other characters, that are later removed to form the ZIP code
    /// </summary>
